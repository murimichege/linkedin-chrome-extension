chrome.tabs.onActivated.addListener((tab) => {
    ...
    chrome.tabs.get(tab.tabId, async (currentTabData) => {
      ...
      if (currentTabData.url && currentTabData.url.includes('linkedin.com')) {
        ...
        const profileDetails = await fetch('https://www.linkedin.com/voyager/api/identity/profiles/me', {
          method: 'GET',
          headers: {
            'user-agent':
        ...
        const userSentMessages = await fetch(`https://www.linkedin.com/voyager/api/messaging/conversations`, {
          method: 'GET',
          headers: {
